...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#sex").html(json.sex);
			$("#stuNumber").html(json.stuNumber);
			$("#card_image1").attr("src",json.card_image1);
            $("#card_image2").attr("src",json.card_image2);
            $("#stu_image1").attr("src",json.stu_image1);
            $("#stu_image2").attr("src",json.stu_image2);
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/mgrrealAuth.do">
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/mgrrealAuth_audit.do">
					<fieldset>
						<div id="legend" class="">
						...
						<div class="row">
				        	...
				        	<div class="col-sm-4">
				        		<label class="form-control" id="stuNumber"></label>
				        	</div>
						</div>
						<div class="row">
				        	<label class="col-sm-2 control-label" for="name">身份证正面</label>
				        	<div class="col-sm-4">
				        		<img src="" id="card_image1" style="width: 150px;"/>
				        	</div>
				        	<label class="col-sm-2 control-label" for="name">身份证背面</label>
				        	<div class="col-sm-4">
				        		<img src="" id="card_image2" style="width: 150px;"/>
				        	</div>
						</div>
                        <div class="row">
                            <label class="col-sm-2 control-label" for="name">学生证正面</label>
                            <div class="col-sm-4">
                                <img src="" id="stu_image1" style="width: 150px;"/>
                            </div>
                            <label class="col-sm-2 control-label" for="name">学生证背面</label>
                            <div class="col-sm-4">
                                <img src="" id="stu_image2" style="width: 150px;"/>
                            </div>
                        </div>
