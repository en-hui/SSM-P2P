						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<table style="width: 100%;height: 100px;">
									...
									<tr>
										<td><span>身份证号码： ${realAuth.idNumber}</span></td>
                                        <td><span>学生证号码： ${realAuth.stuNumber}</span></td>
									</tr>
                                    <#--<tr>
                                        <td><img src='${card_image1}' alt=""></td>
                                        <td><img src="${card_image2}" alt=""></td>
                                    </tr>
                                    <tr>
                                        <td><img src="${stu_image1}" alt=""></td>
                                        <td><img src="${stu_image2}" alt=""></td>
                                    </tr>-->
								</table>
							</div>
						</div>
